        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    int toUser_Name = cursor.getColumnIndex(DBStaticInfo.IM_DBTABLE_toUser_Name.trim());
                    int toUser_icon = cursor.getColumnIndex(DBStaticInfo.IM_DBTABLE_toUser_icon.trim());
                    ...
                    String str_toUser_Name = cursor.getString(toUser_Name);
                    String str_toUser_icon = cursor.getString(toUser_icon);
                    ...
                    user.setLogo(str_toUser_icon);
                    user.setNickName(str_toUser_Name);
