package com.shenma.yueba.fragment.baijia;
...
import com.shenma.yueba.activity.ChooseCityActivity;
import com.shenma.yueba.adapter.baijia.HomeAdapter;
...
import com.shenma.yueba.utils.CityChangeRefreshObserver;
import com.shenma.yueba.utils.LocationUtil;
import com.shenma.yueba.utils.PerferneceUtil;
import com.shenma.yueba.utils.TabViewPgerImageManager;
...
public class IndexFragmentForBaiJia extends Fragment implements CityChangeRefreshInter {
    ...
    void initTitle(View v) {
        //左侧地址
        tv_city = (TextView) v.findViewById(R.id.title_layout_left_textview);
        ...
        tv_city.setText("全国");
        tv_city.setCompoundDrawablesWithIntrinsicBounds(null, null, this.getResources().getDrawable(R.mipmap.arrow_down), null);
        //标题
        TextView title_layout_titlename_textview = (TextView) v.findViewById(R.id.title_layout_titlename_textview);
        title_layout_titlename_textview.setText("Shopping");
        //右侧搜索
        TextView title_layout_right_textview = (TextView) v.findViewById(R.id.title_layout_right_textview);
        title_layout_right_textview.setCompoundDrawablesWithIntrinsicBounds(null, null, this.getResources().getDrawable(R.mipmap.search), null);
