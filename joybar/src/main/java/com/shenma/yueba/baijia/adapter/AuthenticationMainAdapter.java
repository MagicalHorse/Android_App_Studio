 ...
 * 认证买手 列表 适配器
 */
public class AuthenticationMainAdapter extends BaseAdapter {
    Activity activity;
    public AuthenticationMainAdapter(Activity activity)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        {
            holder=new Holder();
            convertView=LayoutInflater.from(activity).inflate(R.layout.authentication_item_layout,null);
    ...
    void setValue(int position,Holder holder)
    {
        ...
        {
            TextView tv=(TextView)view_array.get(i).findViewById(R.id.authentication_child_iten_layout_price_textview);
            tv.setText("第"+position+"行  "+"第"+i+"条数据");
        }
    }
