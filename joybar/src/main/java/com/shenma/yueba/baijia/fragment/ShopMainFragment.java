...
import com.shenma.yueba.util.LoginRefreshObserver;
 ...
 */
public class ShopMainFragment extends Fragment implements LoginRefreshObserver.LoginSucessRefreshLinstener {
    View contantView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (contantView == null) {
            initView();
            LoginRefreshObserver.getInstance().addObserver(this);
        }
    }
    ...
    synchronized void requestRefreshData() {
        ...
        userId= SharedUtil.getStringPerfernece(activity, SharedUtil.user_id);
        ishow = true;
        isrunning = true;
    ...
    public void onDestroy() {
        ...
        LoginRefreshObserver.getInstance().removeObserver(this);
        super.onDestroy();
    }
