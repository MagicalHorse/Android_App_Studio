...
import com.shenma.yueba.baijia.dialog.OrderPaySearchDialog;
...
public class BaijiaPayActivity extends BaseActivityWithTopView implements
        OrderPaySearchDialog.OrderPayOnClick_Listener {
    ...
    private OrderPaySearchDialog orderPayDialog;
    ...
    public void showPayDialogLoading() {
        if (orderPayDialog == null) {
            orderPayDialog = new OrderPaySearchDialog(payResponseFormBean, BaijiaPayActivity.this, this, true);
        }
